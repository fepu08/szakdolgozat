...
dump_timer.start()
(predictions, algorithm) = load("dumped_svdpp_algorithm_and_predictions")
...
cold_start_predictions = algo.test(anti_testset)
...
benchmark_df.to_csv("benchmark-loaded-and-fresh-svdpp-model.csv", index=True)
print(benchmark_df)
